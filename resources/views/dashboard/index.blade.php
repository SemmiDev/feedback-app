                    ...
                    <div class="border-l-4 border-blue-400 pl-4 py-2">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center space-x-1">
                                        ...
                                        <span class="text-xs text-gray-500">{{ $feedback->created_at_for_humans }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="text-right">
                                ...
                                <a href="{{ route('dashboard.feedbacks.show', $feedback) }}" class="text-emerald-600 hover:text-emerald-500 text-sm">
                                    View
                                </a>
                            </div>
                        </div>
