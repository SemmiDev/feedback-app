        ...
        <div class="max-w-md w-full space-y-8">
            <div class="text-center">
                <div class="mb-6">
                    ...
                    <h2
                        class="text-2xl md:text-4xl lg:text-5xl font-extrabold text-emerald-700 drop-shadow-sm tracking-tight">
                        <span class="block">Sistem Evaluasi Cerdas</span>
                        <span class="block text-emerald-900 text-opacity-80 font-bold text-lg md:text-2xl mt-1">Untuk
                            Optimalisasi Dakwah</span>
                    </h2>
                    <p class="mt-4 text-base text-gray-500 italic flex items-center justify-center gap-2">
                        ...
                        Masuk ke <span class="font-semibold text-emerald-700">Panel Admin / Penceramah</span>
                    </p>
                </div>
            </div>
                ...
                <div class="bg-white shadow-xl rounded-lg p-6">
                    <div class="space-y-6">
                        ...
                        <div class="pt-4 text-center">
                            <a href="{{ route('login.pengurus-masjid') }}"
