...
<div class="container mx-auto">
    <div class="bg-white shadow-lg rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-600 mt-1">Update your profile information and password.</p>
        </div>
        ...
        <div class="p-6">
            <form method="POST" action="{{ route('profile.update') }}">
                ...
                <!-- Penceramah Information (if available) -->
                @if($user->isPenceramah() && $user->penceramah())
                    @php $penceramah = $user->penceramah(); @endphp
                    <div class="mb-6 p-4 bg-gray-50 rounded-md">
                        <h3 class="text-sm font-medium text-gray-700 mb-3">Penceramah Information</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                <span class="font-medium text-gray-600">Birth Place:</span>
